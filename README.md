...
      object-fit: cover;
      border-radius: 16px;
  S     border: 2px solid var(--card-border);
      box-shadow: var(--shadow-soft);
    }
...
D           <li>Modernized national HMIS indicators, reporting forms, and DHIS2 implementations to match sector priorities.</li>
...
        <div class="experience__item">
V         <div class="experience__role">Monitoring & Evaluation Roles · CHAI, USAID Programs, Save the Children, I-TECH</div>
          <div class="experience__meta">
            <span>2006 – 2014</span>
            <span>Ethiopia</span>
          </div>
...
s           <li>Executed routine data quality assessments, surveys, and evidence-based reporting for USAID-funded programs.</li>
...
s               <li>Includes: 7 Lessons · 1 Topic · 1 Quiz</li>
...
Read           <div class="lesson__header">
                <h4 id="key-outcomes">Key Outcomes</h4>
              </div>
              <ul>
                <li>Create professional websites, documents, and presentations with AI assistance.</li>
s               <li>Conduct literature reviews, analyze data, and build dashboards using intuitive AI tools.</li>
...
                    g   <li>Diminishing returns at higher GDP levels (above ~$20,000)</li>
                        <li>Life expectancy ranges from approximately 55 to 85 years globally</li>
                      </ul>
                      
                      <div class="report-container">
s                       <div class="report-tabs">
...
F                         <button class="report-tab" onclick="switchTab('gdp', 'findings')">Key Findings</button>
                          <button class="report-tab" onclick="switchTab('gdp', 'reflection')">Reflection</button>
                        </div>
                Type       <div class="report-content">
...
s                             <li>Creation of an interactive scatter plot using Plotly to visualize the relationship between log(GDP per capita) and life expectancy.</li>
                              <li>Correlation analysis to quantify the strength of the association.</li>
                            </ul>
                          </div>
s                         <div id="gdp-findings" class="report-text" style="display: none;">
...
                          </div>
s                         <div id="gdp-reflection" class="report-text" style="display: none;">
s                         <h3>Personal Reflection</h3>
...
s                   <span>Project from Lesson 02</span>
                    <span>Date: Oct 20, 2025</span>
                  </div>
                  
                  <div class="project-cta">
s                   <a href="https://z-cdn-media.chatglm.cn/files/19d0e2e8-4670-43f1-bd5f-e53b471acb8e_Ftalew_Dagnaw_GDP_Analysis.pdf?auth_key=1761857702-3c224213d2a74c43ab98d975a6c11b0e-0-f70d240292b2d075217ba3f8d16858e7" class="pdf-button pdf-button-primary" download="Ftalew_Dagnaw_GDP_Analysis.pdf">Download Report (PDF)</a>
                    <a href="https://z-cdn-media.chatglm.cn/files/6b9d62d0-9f57-4148-af7e-3bb64dd50ca1_Ftalew_Dagnaw_GDP_Analysis.pptx?auth_key=1761857702-83b631d686f043d8a7c2090885e334a1-0-280d0d1921c5f35d21ba4802c672b152" class="pdf-button pdf-button-secondary" download="Ftalew_Dagnaw_GDP_Analysis.pptx">Download Slides (PPTX)</a>
Next               </div>
                </div>
              </label>
...
s                 <input type="checkbox" class="lesson-checkbox" />
                </div>
                <p style="color: var(--text-muted); margin: 0;">
                  Leveraging AI to synthesize research, clean data, and generate insights from datasets.
                </p>
                
                E               <div class="project-card" style="margin-top: 1.5rem; background: rgba(5, 28, 96, 0.85);">
...
                      <span class="access-badge">
                all       <svg width="12" height="12" fill="currentColor" viewBox="0 0 20 20">
                          <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                        </svg>
                D       Completed
                      </span>
...
                    <a href="Job market analysis report.pdf" class="pdf-button pdf-button-primary" download>
                      <svg width="16" height="16" fill="currentColor" viewBox="0 0 20 20">
S                         <path fill-rule="evenodd" d="M3 17a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm3.293-7.707a1 1 0 011.414 0L9 10.586V3a1 1 0 112 0v7.586l1.293-1.293a1 1 0 111.414 1.414l-3 3a1 1 0 01-1.414 0l-3-3a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                      </svg>
...
                D <input type="checkbox" class="lesson-checkbox" />
                </div>
                <p style="color: var(--text-muted); margin: 0;">
...
              <label class="lesson">
                <div class="lesson__header">
s                 <h4>07 · Capstone & Final Quiz</h4>
                  <input type="checkbox" class="lesson-checkbox" />
                </div>
                <p style="color: var(--text-muted); margin: 0;">
...
          <li>
            <span>LinkedIn:</span>
            <a href="httpsA://www.linkedin.com/in/ftalew-dagnaw-gebreyesus-mph-b95b8535/" target="_blank" rel="noopener noreferrer">
              /in/ftalew-dagnaw-gebreyesus-mph
  s         </a>
          </li>
          <li>
            <span>Location:</span>
s           Addis Ababa, Ethiopia
          </li>
        </ul>
      </div>
    </section>
...
s             navToggle.setAttribute('aria-expanded', 'false');
